<%@include file="/common/taglib.jsp"%>
    ...
    pageEncoding="UTF-8"%>
        ...
        <body>
            <div class="col-sm-9">
                <h2 class="pt-3">Parking lot list</h2>
                <hr class="border">
                ...
                <form action="<c:url value='/car-park-parking-lot-list'/>" id="formSubmit" method="get">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                <td><input type="checkbox" id="checkbox_${item.parkId}" value="${item.parkId}"></td>
                                                <td>${item.parkId}</td>
                                                <td>${item.parkName}</td>
                                                ...
                                                <td>
                                                    <c:url var="editURL" value="/car-park-parking-lot-list">
                                                        <c:param name="type" value="edit" />
                                                        <c:param name="parkId" value="${item.parkId}" />
                                                    </c:url>
